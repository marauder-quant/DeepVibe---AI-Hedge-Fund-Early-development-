"""
Analyze S&P 500 stocks (indices 250-350) based on economic quadrant
...
def analyze_stocks_batch(start_idx=250, end_idx=350):
    """
...
def create_consolidated_csv():
    """
    Create a consolidated CSV file with all top-graded stocks from all batches
    
    Returns:
    - consolidated_df: DataFrame with all top-graded stocks
    """
    print("Creating consolidated CSV file with all top-graded stocks...")
    ...
    consolidated_df.to_csv('consolidated_top_stocks.csv', index=False)
    print(f"Consolidated {len(consolidated_df)} top-graded stocks into 'consolidated_top_stocks.csv'")
    
    return consolidated_df

if __name__ == "__main__":
    # Analyze stocks from indices 250-350
    graded_stocks, top_stocks = analyze_stocks_batch(250, 350)
    
    # Create consolidated CSV file
    consolidated_df = create_consolidated_csv()
    
    print("\nTop Stocks from Batch 250-350:")
